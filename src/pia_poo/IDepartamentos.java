...
public interface IDepartamentos {
    ...
    "Este empleado mantiene ordenada el area de electronica, asi como ayuda a los clientes a escoger celulares, computadoras, televisores o cualquier accesorio para estos",
    "Este empleado mantiene ordenada el area de jugueteria, expone los juguetes mas llamativos y prepara los juguetes como regalo en caso de que el cliente lo requiera",
    "Este empleado mantiene ordenada el area de panaderia, asi como prepara y hornea los panes, y empaqueta el pan que la gente compra"
    };
}
